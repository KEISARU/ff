...
static const _Digipot_type_support_symbol_names_t _Digipot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, digipot_interfaces, msg, Digipot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, digipot_interfaces, msg, Digipot)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, digipot_interfaces, msg, Digipot)() {
  return &::digipot_interfaces::msg::rosidl_typesupport_c::Digipot_message_type_support_handle;
}
