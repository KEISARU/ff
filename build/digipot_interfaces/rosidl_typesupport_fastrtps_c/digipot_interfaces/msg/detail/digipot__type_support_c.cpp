...
#include "digipot_interfaces/msg/detail/digipot__rosidl_typesupport_fastrtps_c.h"
...
#include "digipot_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Digipot__ros_msg_type = digipot_interfaces__msg__Digipot;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_digipot_interfaces
size_t get_serialized_size_digipot_interfaces__msg__Digipot(
  const void * untyped_ros_message,
...
static uint32_t _Digipot__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_digipot_interfaces__msg__Digipot(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_digipot_interfaces
size_t max_serialized_size_digipot_interfaces__msg__Digipot(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Digipot__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_digipot_interfaces__msg__Digipot(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, digipot_interfaces, msg, Digipot)() {
