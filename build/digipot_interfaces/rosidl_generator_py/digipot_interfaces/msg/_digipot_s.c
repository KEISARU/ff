...
bool digipot_interfaces__msg__digipot__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("digipot_interfaces.msg._digipot.Digipot", full_classname_dest, 39) == 0);
  }
  digipot_interfaces__msg__Digipot * ros_message = _ros_message;
  {  // value
...
PyObject * digipot_interfaces__msg__digipot__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("digipot_interfaces.msg._digipot");
