...
static const _Digipot_type_support_symbol_names_t _Digipot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, digipot_interfaces, msg, Digipot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, digipot_interfaces, msg, Digipot)),
  }
};
...
{
  return &::digipot_interfaces::msg::rosidl_typesupport_cpp::Digipot_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, digipot_interfaces, msg, Digipot)() {
  return get_message_type_support_handle<digipot_interfaces::msg::Digipot>();
}
