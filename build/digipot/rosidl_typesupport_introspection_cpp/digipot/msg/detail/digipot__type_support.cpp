...
{
  new (message_memory) digipot::msg::Digipot(_init);
}

void Digipot_fini_function(void * message_memory)
{
  auto typed_message = static_cast<digipot::msg::Digipot *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Digipot_message_member_array[3] = {
  {
    ...
    offsetof(digipot::msg::Digipot, value),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(digipot::msg::Digipot, wiper),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(digipot::msg::Digipot, high),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Digipot_message_members = {
  "digipot::msg",  // message namespace
  "Digipot",  // message name
  3,  // number of fields
  sizeof(digipot::msg::Digipot),
...
{
  return &::digipot::msg::rosidl_typesupport_introspection_cpp::Digipot_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, digipot, msg, Digipot)() {
  return &::digipot::msg::rosidl_typesupport_introspection_cpp::Digipot_message_type_support_handle;
}
